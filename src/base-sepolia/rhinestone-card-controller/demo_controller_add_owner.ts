...
const main = async () => {
  console.log(chalk.bold("\n=== Controller account: addOwner on ControllerValidator (Base Sepolia) ===\n"));
  ...
  if (after.owners.some((o) => o.toLowerCase() === newSigner.toLowerCase())) {
    ...
    console.log(`Set BASE_SEPOLIA_CARD_ACCOUNT_CONTROLLER=${address} for the *_new_signer scripts`);
  } else {
