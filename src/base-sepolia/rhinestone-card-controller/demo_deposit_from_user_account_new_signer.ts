...
if (
  ...
  throw new Error(
    "NEW_CONTROLLER_SIGNER_PRIVATE_KEY, BASE_SEPOLIA_CARD_ACCOUNT_CONTROLLER, CONTROLLER_VALIDATOR_ADDRESS, RHINESTONE_API_KEY, or BASE_SEPOLIA_CARD_ACCOUNT_ADDRESS is not set"
  );
}
