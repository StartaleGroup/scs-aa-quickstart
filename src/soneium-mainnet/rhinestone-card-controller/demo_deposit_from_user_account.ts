...
if (!privateKey || !controllerValidatorAddress || !rhinestoneApiKey || !cardAccountAddress || !usdscAddress) {
  throw new Error(
    "OWNER_PRIVATE_KEY, CONTROLLER_VALIDATOR_ADDRESS, RHINESTONE_API_KEY, MAINNET_CARD_ACCOUNT_ADDRESS, or MAINNET_USDSC_ADDRESS is not set"
  );
}
