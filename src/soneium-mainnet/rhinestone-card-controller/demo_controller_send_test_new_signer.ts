...
if (!newSignerPrivateKey || !controllerAddress || !controllerValidatorAddress || !rhinestoneApiKey) {
  throw new Error(
    "NEW_CONTROLLER_SIGNER_PRIVATE_KEY, MAINNET_CARD_ACCOUNT_CONTROLLER, CONTROLLER_VALIDATOR_ADDRESS, or RHINESTONE_API_KEY is not set"
  );
}
...
const main = async () => {
  console.log(chalk.bold("\n=== Controller account (new signer): sendUserOperation vs sendTransaction (Soneium Mainnet) ===\n"));
