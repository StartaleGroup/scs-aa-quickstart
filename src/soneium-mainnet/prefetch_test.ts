...
const TARGET = "0x2cf491602ad22944D9047282aBC00D3e52F56B37" as Address;
const calls = [{ to: TARGET, value: 0n, data: "0x" as Hex }];
...
const main = async () => {
  ...
  // ── SUMMARY ─────────────────────────────────────────────────────
  console.log(label("Summary — Soneium Mainnet"));
